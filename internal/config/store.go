...
// It implements platform.ConfigStore.
...
func (s *FileStore) Load(_ context.Context, scope platform.ConfigScope) ([]byte, error) {
	name := "config.toml"
	if scope.GuildID != 0 {
...
func (s *FileStore) Watch(_ context.Context, _ platform.ConfigScope) <-chan struct{} {
	return nil
}
